...
💡 **Dica de portfólio para você (muito importante):**

Coloque no GitHub com um nome tipo:
...
Isso ajuda muito quando recrutadores pesquisam projetos.

---

Se quiser, também posso te ajudar a criar:

- 🧠 **arquitetura profissional do projeto**
- 🎮 **IA do dominó**
- 🌐 **dominó multiplayer online**
- 🧩 **renderização profissional das peças**

E transformar isso em **um projeto de 3000+ linhas que fica MUITO forte no GitHub**.